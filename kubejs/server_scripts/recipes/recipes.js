ServerEvents.recipes(event => {
    ...
    removeGtceu([ "flint_knife", "flint_shovel", "flint_pickaxe", "flint_mortar", "flint_sword", "flint_hoe", "flint_axe", "compressed_fireclay", "coke_oven_bricks", "steam_large_turbine" ])
