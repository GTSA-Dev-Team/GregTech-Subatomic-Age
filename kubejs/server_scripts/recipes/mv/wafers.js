ServerEvents.recipes(gtsa => {
    removeGtceu(gtsa, [ 'silicon_boule', 'phosphorus_boule', 'naquadah_boule', 'neutronium_boule', 'silicon_wafer' ])

    ////     SILICON PURIFICATION

    gtsa.recipes.gtceu.electric_arc_furnace('metallurgical_grade_silicon')
    ...
    gtsa.recipes.gtceu.fixed_bed_reactor('hydrochlorination_silicon')
    ...
    gtsa.recipes.gtceu.distillation_tower('trichlorosilane_distillation')
    ...
    gtsa.recipes.gtceu.fixed_bed_reactor('silicon_tetrachloride_reuse')
        .notConsumable('gtceu:copper_catalyst')
        .inputFluids('gtceu:silicon_tetrachloride 1000', 'gtceu:hydrochloric_acid 2000')
        .itemInputs('gtceu:metallurgical_grade_silicon_dust')
        .outputFluids('gtceu:impure_trichlorosilane 2000')

    gtsa.recipes.gtceu.fixed_bed_reactor('trichlorosilane_cvd')
    ...
    gtsa.recipes.gtceu.macerator('silicon_rods_maceration')
        .itemInputs("gtceu:silicon_rods")
        .itemOutputs("2x gtceu:silicon_chunks")

    gtsa.recipes.gtceu.extractor('polysilicon_extraction')
        .itemInputs('2x gtceu:silicon_chunks')
        .outputFluids('gtceu:polysilicon 144')

    //// BOULE CREATION

    gtsa.recipes.gtceu.autoclave('silicon_seed_crystal')
    ...
    gtsa.recipes.gtceu.vacuum_ejection('quartz_crucible')
    ...
    gtsa.recipes.gtceu.cz_furnace('silicone_boule_growth')
    ...
    const genCutterRecipes = (fluidsToAmountMap, wafer, seed, boule) => {
        fluidsToAmountMap.forEach(holder => {
            gtsa.recipes.gtceu.cutter(`${wafer.wafer}_${boule}_${holder.fluid}_${seed}_cutting`)
