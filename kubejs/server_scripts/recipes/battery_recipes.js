ServerEvents.recipes(gtsa => {
    ...
    gtsa.remove({ output: "gtceu:lv_lithium_battery" })

    gtsa.shaped('gtsac:lead_battery_cathode', [
        '   ',
        'CP ',
        '   '
    ], { C: "gtceu:tin_single_cable", P: "gtceu:battery_alloy_plate" })

    gtsa.shaped('gtsac:lead_battery_anode', [
        '   ',
        ' PC',
        '   '
    ], { C: "gtceu:tin_single_cable", P: "gtceu:battery_alloy_plate" })

    gtsa.recipes.gtceu.chemical_reactor('iron_iii_sulfate_dust')
        .itemInputs('2x gtceu:pyrite_dust')
        .itemOutputs([ 'gtceu:iron_iii_sulfate_dust', 'gtceu:sulfur_dust' ])
        .EUt(8)
        .duration(20 * 5)
    
    gtsa.recipes.gtceu.chemical_reactor('sulfur_trioxide_steam_age_recipe')
