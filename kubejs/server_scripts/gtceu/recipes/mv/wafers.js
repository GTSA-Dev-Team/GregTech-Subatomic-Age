ServerEvents.recipes(event => {
    ...
    removeGtceu(event, [ 'silicon_rod' ])

    ////     SILICON PURIFICATION

    event.recipes.gtceu.electric_arc_furnace('metallurgical_grade_silicon')
        .itemInputs('gtceu:silicon_dust', '2x gtceu:carbon_dust')
    ...
    event.recipes.gtceu.fixed_bed_reactor('hydrochlorination_silicon')
        ...
        .outputFluids('gtceu:impure_trichlorosilane 1000', 'gtceu:hydrogen 1000')
        .duration(15 * 20)
        .EUt(128)
    ...
    event.recipes.gtceu.fixed_bed_reactor('trichlorosilane_cvd')
        ...
        .itemOutputs('2x gtceu:silicon_rod')
        .outputFluids('gtceu:hydrochloric_acid 6000')
        .duration(30 * 20)
        .EUt(128)

    event.recipes.gtceu.macerator('silicon_rod_maceration')
        .itemInputs("gtceu:silicon_rod")
