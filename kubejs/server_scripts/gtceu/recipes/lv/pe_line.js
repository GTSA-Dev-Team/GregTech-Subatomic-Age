ServerEvents.recipes(gtsa => {
    ...
    gtsa.recipes.gtceu.distillery('ethanol_biomass_distillation')
    ...
    gtsa.shaped('gtceu:polymerization_tank', [
        'RRR',
        'PHP',
        'ECE'
    ], {
    ...
    gtsa.recipes.gtceu.distillery('ammonia_synthesis')
        .circuit(5)
    ...
    gtsa.recipes.gtceu.fixed_bed_reactor('benzaldehyde_synthesis')
    ...
    gtsa.recipes.gtceu.fixed_bed_reactor('aniline_synthesis')
    ...
    gtsa.recipes.gtceu.rotary_kiln('dichlorido_bis_n_benzylideneaniline_iron_ii_catalyst')
    ...
    gtsa.recipes.gtceu.polymerization_tank('ethylene_polimerization')
    ...
    gtsa.recipes.gtceu.polymerization_tank('ethylene_polimerization_oxygen')
        .notConsumable("gtceu:dichlorido_bis_n_benzylideneaniline_iron_ii_catalyst_dust")
    ...
    gtsa.recipes.gtceu.chemical_reactor('iron_ii_chloride_synthesis')
